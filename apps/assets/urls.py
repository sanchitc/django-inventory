...
from generic_views.views import (generic_assign_remove, generic_delete,
    generic_detail, generic_list)
from inventory import location_filter
from photos.views import generic_photos

from .conf import settings as asset_settings
from .forms import (ItemForm, ItemForm_view, ItemGroupForm,
    ItemGroupForm_view, PersonForm, PersonForm_view)
